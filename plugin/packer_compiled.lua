...
_G.packer_plugins = {
  ...
  ["color-picker.nvim"] = {
    ...
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/color-picker.nvim",
  ...
  nightfly = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/nightfly",
  ...
  ["nvim-highlight-colors"] = {
    loaded = true,
    path = "/home/dev/.local/share/nvim/site/pack/packer/start/nvim-highlight-colors",
